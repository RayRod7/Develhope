...
/*
    ...
    public static void exercise4() {
        System.out.println("\nExercise 4:");
        for (int week = 0; week < 52; week++) { // (int week = 0; week < WEEKS_IN_A_YEAR; week++)
            for (int day = 0; day < 7; day++) { // (int day = 0; day < DAYS_IN_A_WEEK; day++)
                for (int hour = 0; hour < 24; hour++) { // (int hour = 0; hour < HOURS_IN_DAY; hour++)
