...
public class Main {
    ...
    public static void exercise2() {
        ...
        switch (inputNumber) {
            case 2:
                ...
                break;
            case 3:
                System.out.println("This the 7th largest prime number under 20");
                break;
            case 5:
                System.out.println("This the 6th largest prime number under 20");
                break;
            case 7:
                System.out.println("This the 5th largest prime number under 20");
                break;
            case 11:
                System.out.println("This the 4th largest prime number under 20");
                break;
            case 13:
                System.out.println("This the 3rd largest prime number under 20");
                break;
            case 17:
                System.out.println("This the 2nd largest prime number under 20");
                break;
            case 19:
    ...
    public static void exercise3Bonus() {
        ...
        int inputNumberArrow = 19;

        switch (inputNumberArrow){
            case 2 -> System.out.println("This the smallest prime number under 20");
            case 3 -> System.out.println("This the 7th largest prime number under 20");
            case 5 -> System.out.println("This the 6th largest prime number under 20");
            case 7 -> System.out.println("This the 5th largest prime number under 20");
            case 11 -> System.out.println("This the 4th largest prime number under 20");
            case 13 -> System.out.println("This the 3rd largest prime number under 20");
            case 17 -> System.out.println("This the 2nd largest prime number under 20");
