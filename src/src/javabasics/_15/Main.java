...
public class Main {
    ...
    private static void exercise1() {
        ...
        while (yearsPast <= 5 || currentInvestmentValueEuros < 15_000) { //1a: (currentInvestmentValueEuros < 100_000)
    ...
    private static void exercise2() {
        ...
        while (remainingPoundsToSell > 0) {
            ...
            if (poundToEuroExchangeRate > 1.15) {
                ...
                System.out.println("Day: " + daysToSell + " it remains" + remainingPoundsToSell + "£ to sell");
            } else {
                System.out.println("Day: " + daysToSell + " the exchange rate is lower than 1.15");
            }
        }
