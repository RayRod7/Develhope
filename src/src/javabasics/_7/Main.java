...
public class Main {
    ...
    private static void exercise3() {
        System.out.println("\nExercise 3:");
        //non ho capito lo scopo di questo esercizio, qualunque Primitive inserisco risulterà errore se almeno
        // una non è una stringa, ma mi sembra ovvio dato che prima del nome della variabile troviamo, appunto, String.
        String textFrom2Primitives = "I Love you " + 3000; // <--- Edit this line
    ...
    private static void exercise4() {
        ...
        String middleNumbers = "       4 5 6"; //se mettessi lo spazio dopo il 6 non lo stamperebbe a causa del comando trim
