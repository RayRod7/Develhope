package src.javainproduction._2;
...
public class Exercises {
    ...
    private static void oddNumbersFinder() {
        ...
        ourNumbers.stream()
                .filter(number -> number % 2 != 0)
                .forEach(number -> oddNumbers.add(number));
    ...
    private static void exercise3() {
        ...
        Set<String> namesUpperCase = alice.stream()
    ...
    private static void exercise4() {
        System.out.println("\nExercise 4");
        Set<Integer> evenNumbersMultiplied = ourNumbers.stream()
                .filter(num -> num % 2 == 0)
                .map(num -> num * 2)
                .collect(Collectors.toSet());

        System.out.println(evenNumbersMultiplied);
        //Your code here
    }
}
